...
public struct Song: SongProtocol, Decodable, Sendable, Equatable {
...
public struct SongImage: SongImageProtocol, Decodable, Sendable, Equatable {
    public let id: String
    public let url: String
  
  public static func == (lhs: SongImage, rhs: SongImage) -> Bool {
    return lhs.id == rhs.id
  }
...
public struct Artist: ArtistProtocol, Decodable, Sendable, Equatable {
    public let id: String
    public let name: String
...
public struct SongHLS: SongHLSProtocol, Decodable, Sendable, Equatable {
    public let id: String
    public let url: String
    public let durationInSeconds: Int
    public let urlExpiresAtISO: String
  
    public static func == (lhs: SongHLS, rhs: SongHLS) -> Bool {
      return lhs.id == rhs.id
    }
...
public struct SongMP3: SongMP3Protocol, Decodable, Sendable, Equatable {
    public let id: String
    public let url: String
    public let durationInSeconds: Int
    public let urlExpiresAtISO: String
  
    public static func == (lhs: SongMP3, rhs: SongMP3) -> Bool {
      return lhs.id == rhs.id
    }
...
public struct Audio: AudioProtocol, Decodable, Sendable, Equatable {
    public let hls: SongHLS
    public let mp3: SongMP3
  
    public static func == (lhs: Audio, rhs: Audio) -> Bool {
      return lhs.hls == rhs.hls && lhs.mp3 == rhs.mp3
  }
