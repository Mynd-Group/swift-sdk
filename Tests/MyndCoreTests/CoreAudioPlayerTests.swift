...
final class CoreAudioPlayerProgressTests: XCTestCase {
    ...
    func createTestPlaylist(songCount: Int = 2) -> PlaylistWithSongs {
    ...
    func testProgressUpdates_MustBeConsistentAndValid() async {
        // Given
        let playlist = createTestPlaylist(songCount: 1)
    ...
    func testProgressUpdates_MustUpdateTrackIndex() async {
        // Given
        let playlist = createTestPlaylist(songCount: 2)
        var progressUpdates: [PlaybackProgress] = []
